defmodule Icu.MessageFormat.Parser.SelectOrdinalArgument do
  import NimbleParsec
  ...
  def make_selectordinal_argument({data, metadata}) do
  ...
  def combinator(message_combinator) do
    ...
    selectordinal_argument =
      ...
      |> Utils.add_location()
      |> map({__MODULE__, :make_selectordinal_argument, []})
